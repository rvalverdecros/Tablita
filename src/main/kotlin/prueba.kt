...
fun main(){
    ...
    val cuatro= listOf("Duracion",1,1,1,15/100,1,1,1)
    ...
    val nueve = listOf("Viernes","BD","BD","PROG","EO","PROG","SSII")
    ...
    val dos = table {
        ...
        for (i in 1..uno.size-2){
            row(uno[i],tres[i],cuatro[i] as Double,cinco[i],seis[i],siete[i],ocho[i],nueve[i],diez[i] as Double)
        }
